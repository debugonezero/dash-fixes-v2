...
const faqData = [
  {
    question: 'What kind of parts do you use for batteries, charging ports, and back glass?',
  ...
  {
    question: 'Why do you replace the whole back housing on some iPhone models?',
    answer: "For iPhone models before the iPhone 14 (non-Pro), replacing only the back glass with a third-party part can compromise the device's structural integrity and water resistance. To guarantee a factory-quality repair, we replace the entire back housing with a Genuine unit. This ensures the repair is durable and maintains the original feel and resistance of the device.",
  },
  {
    question: 'What about parts for MacBooks?',
    answer: 'Our commitment to quality extends to all Apple products. We use specific, high-quality parts for each type of MacBook repair:<br>- <strong>Screens:</strong> We use Genuine, Refurbished, or Premium quality displays to ensure a perfect picture.<br>- <strong>Batteries:</strong> We use either Genuine or high-quality Premium batteries for longevity and safety.<br>- <strong>Keyboards & Trackpads:</strong> For these critical components, we <strong>only</strong> use Genuine parts to guarantee a perfect fit, feel, and long-term reliability.',
  },
  {
    question: 'What payment methods do you accept?',
    answer: 'We accept a variety of payment methods for your convenience, including <strong>Credit/Debit Cards, Apple Pay, Google Pay, and Venmo</strong>. All card payments are processed securely through Square.',
  },
  {
    question: 'What payment methods do you accept?',
    answer: 'We accept a variety of payment methods for your convenience, including <strong>Credit/Debit Cards, Apple Pay, Google Pay, and Venmo</strong>. All card payments are processed securely through Square.',
...
const FaqItem = ({ faq, isOpen, onToggle }: { faq: { question: string; answer: string; }, isOpen: boolean, onToggle: () => void }) => {
  return (
    <div className="border-b border-gray-200 dark:border-gray-700 py-6">
      ...
      >
        <h3 className="text-xl font-heading font-bold text-textDark dark:text-textLight">{faq.question}</h3>
        <span className="text-accentBlue">
          {isOpen ? <ChevronUp /> : <ChevronDown />}
        </span>
      </button>
      {isOpen && (
        <div className="mt-4 text-textSubtleDark dark:text-textSubtleLight">
...
const FaqPage = () => {
  ...
  return (
    <div className="bg-white dark:bg-darkTeal py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <AnimationWrapper>
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4 text-textDark dark:text-textLight">Frequently Asked Questions</h1>
          </div>
        </AnimationWrapper>
