...
export default async function ShippingLabelPage({ params }: PageProps) {
  ...
  // Verify the service request exists and payment was successful
    ...
    return (
      <div className="min-h-screen bg-solarized-light dark:bg-solarized-dark flex items-center justify-center">
        <div className="text-center">
          ...
          <p>Please complete your payment before generating a shipping label.</p>
        </div>
      </div>
    );
  }

  const formattedServiceNumber = formatServiceNumber(serviceNumber);
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-solarized-dark3 dark:text-solarized-light3 mt-1">
                        Remove accessories, include your service number: <strong>{formattedServiceNumber}</strong>
                      </p>
                    </div>
                  </div>
          ...
          <div className="text-center mt-8">
            <div className="bg-solarized-yellow bg-opacity-10 border border-solarized-yellow rounded-lg p-4 inline-block">
              <p className="text-solarized-dark2 dark:text-solarized-light font-semibold">
                Remember to include your Service Number: <strong>{formattedServiceNumber}</strong>
              </p>
              <p className="text-sm text-solarized-dark3 dark:text-solarized-light3 mt-1">
