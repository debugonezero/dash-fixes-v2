...
export default function WhatsAppChat() {
  ...
  const defaultMessage = 'Hi! I need help with a device repair quote.';
  ...
  return (
    <>
      ...
      {/* Chat Preview (when button clicked) */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 bg-white dark:bg-solarized-dark2 rounded-lg shadow-xl border border-gray-200 dark:border-solarized-dark3 p-4 max-w-xs">
          ...
          <p className="text-sm text-solarized-dark3 dark:text-solarized-light3 mb-4">
            Hi! Need help with a device repair? Let's chat!
          </p>
